...
| T-105 | M5 second RC | **F-094 + F-096 corrections merged** (was: "Day 6") | full pinned, 20 legs | ~7 h | remaining failures explained and classified — **STATUS: `HELD` per D-063 (2026-08-22). NOT RUN.** T-104 ran 2026-08-21/22 (`runs_verify/2026-08-21_2239`, `2673067`), so the old blocker "T-104 has not run" is discharged. The blocker is now **"F-094 and F-096 corrections not yet merged"** — T-105's acceptance (*remaining* failures) is meaningless until corrections exist, and re-running the same 20 legs against unchanged code would collapse the two RCs, forbidden since PACK 9. **F-095/D-062 is NOT in T-105's prerequisite chain** and may be sequenced independently. |
