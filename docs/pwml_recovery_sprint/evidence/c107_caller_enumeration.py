...
CHANGED = {
    ...
    "_ATTENUATION_STEM_SRC", "_ATTENUATION_OBJECT_SRC", "_ATTENUATION_GAP",
    "_PASSIVE_AGENT_VERBS_SRC", "_PASSIVE_AGENT_MODIFIERS_SRC",
    "_PASSIVE_AGENT_MAX_MODIFIERS",
    # correction round 1: _ACTIVITY_ATTENUATION_SRC is gone, replaced by the
    # actor-anchored frames built inside _span_licenses_actor.
    "_COFACTOR_DEPENDENCE_SRC", "_COFACTOR_MODIFIERS_SRC",
    "_COFACTOR_MAX_MODIFIERS",
