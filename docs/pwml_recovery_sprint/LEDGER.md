...
| H-004 | Durable, version-controlled G11 evidence | `READY` | H-003 ✔ | read at dispatch | `agent/h04-durable-g11-evidence` | assigned at dispatch | `TEST_MATRIX.md` § 0; `_SHARED_BLOCKS.md` block S8; NEW `evidence/g11/` | `pwml-reviewer`, then `pwml-test-runner` | field-presence + collision checks | smoke | — | — | — |
