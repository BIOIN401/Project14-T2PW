...
See `TEST_MATRIX.md` § Commands. Smoke = **465** tests, ~40 s. Chunk D = **187** tests: the
deterministic core is 160 tests in ~1 s, and the **complete 187-test gate costs 9–13 min**,
