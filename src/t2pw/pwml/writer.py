...
def _add_end_flat_arrow(edge: Dict[str, Any]) -> None:
    opts: Dict[str, Any] = {"end_arrow": False, "end_flat_arrow": True, "start_arrow": False, "start_flat_arrow": False}
    edge["options"] = json.dumps(opts)
