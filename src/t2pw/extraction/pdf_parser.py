...
Usage (standalone):
  python -m t2pw.extraction.pdf_parser --in paper.pdf --out text.txt
  python -m t2pw.extraction.pdf_parser --in paper.pdf --pages 1-10 --out text.txt

Usage (as module):
  from t2pw.extraction.pdf_parser import extract_text_from_pdf, parse_pdf
