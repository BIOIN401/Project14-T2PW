...
if st.session_state.get("pipeline_ready"):
    if st.button("Run audit and DB mapping", key="pwml_generate_btn"):
        st.session_state["post_pipeline_artifacts"] = {'gate_failed': False, 'normalization_gate_failed': False, 'gate_fail_report': {}, 'export_mode': 'research', 'research_review_flags': [], 'research_skipped_format_rules': [], 'research_normalization_actions': [], 'final_mapped_db': {'entities': {'compounds': [{'name': 'menaquinone'}, {'name': 'demethylmenaquinone'}], 'proteins': [{'name': 'MenG'}]}, 'processes': {'reactions': [{'name': 'menaquinone demethylation', 'inputs': ['menaquinone'], 'outputs': ['demethylmenaquinone']}]}}, 'final_mapped': {'entities': {'compounds': [{'name': 'menaquinone'}, {'name': 'demethylmenaquinone'}], 'proteins': [{'name': 'MenG'}]}, 'processes': {'reactions': [{'name': 'menaquinone demethylation', 'inputs': ['menaquinone'], 'outputs': ['demethylmenaquinone']}]}}, 'mapping_report': {'summary': {'mapped': 3}}, 'post_extraction_contract_report': {'ok': True, 'errors': [], 'warnings': []}, 'pre_export_runtime_schema_report': {'ok': False, 'boundary': 'pre_export', 'mode': 'report', 'errors': [{'code': 'entity_missing_mapping_meta', 'pointer': '/entities/subcellular_locations/0/mapping_meta', 'message': 'Mapped entity with a name is missing mapping_meta.', 'expected': 'object'}, {'code': 'entity_missing_mapping_meta', 'pointer': '/entities/subcellular_locations/1/mapping_meta', 'message': 'Mapped entity with a name is missing mapping_meta.', 'expected': 'object'}, {'code': 'entity_missing_mapping_meta', 'pointer': '/entities/subcellular_locations/2/mapping_meta', 'message': 'Mapped entity with a name is missing mapping_meta.', 'expected': 'object'}, {'code': 'entity_missing_mapping_meta', 'pointer': '/entities/subcellular_locations/3/mapping_meta', 'message': 'Mapped entity with a name is missing mapping_meta.', 'expected': 'object'}, {'code': 'entity_missing_mapping_meta', 'pointer': '/entities/subcellular_locations/4/mapping_meta', 'message': 'Mapped entity with a name is missing mapping_meta.', 'expected': 'object'}, {'code': 'entity_missing_mapping_meta', 'pointer': '/entities/subcellular_locations/5/mapping_meta', 'message': 'Mapped entity with a name is missing mapping_meta.', 'expected': 'object'}, {'code': 'entity_missing_mapping_meta', 'pointer': '/entities/subcellular_locations/6/mapping_meta', 'message': 'Mapped entity with a name is missing mapping_meta.', 'expected': 'object'}, {'code': 'entity_missing_mapping_meta', 'pointer': '/entities/subcellular_locations/7/mapping_meta', 'message': 'Mapped entity with a name is missing mapping_meta.', 'expected': 'object'}, {'code': 'entity_missing_mapping_meta', 'pointer': '/entities/subcellular_locations/8/mapping_meta', 'message': 'Mapped entity with a name is missing mapping_meta.', 'expected': 'object'}, {'code': 'entity_missing_mapping_meta', 'pointer': '/entities/subcellular_locations/9/mapping_meta', 'message': 'Mapped entity with a name is missing mapping_meta.', 'expected': 'object'}, {'code': 'entity_missing_mapping_meta', 'pointer': '/entities/subcellular_locations/10/mapping_meta', 'message': 'Mapped entity with a name is missing mapping_meta.', 'expected': 'object'}, {'code': 'entity_missing_mapping_meta', 'pointer': '/entities/subcellular_locations/11/mapping_meta', 'message': 'Mapped entity with a name is missing mapping_meta.', 'expected': 'object'}], 'warnings': [], 'summary': {'error_count': 1, 'warning_count': 0}}}
